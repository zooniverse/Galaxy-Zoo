...
IllustrisTree = new DecisionTree 'illustris', ->
  @question 'Shape', 'Is the galaxy simply smooth and rounded, with no sign of a disk?', ->
    ...
    @answer 'Features or disk', leadsTo: 'Could this be a disk viewed edge-on?', icon: 'feature', examples: 1
  ...
  @question 'Disk', 'Could this be a disk viewed edge-on?', ->
    ...
    @answer 'No', leadsTo: 'Is there any sign of a bar feature through the center of the galaxy?', icon: 'no', examples: 1
  ...
  @question 'Bar', 'Is there any sign of a bar feature through the center of the galaxy?', leadsTo: 'Is there any sign of a spiral arm pattern?', ->
    ...
    @answer 'Bar', icon: 'yes', examples: 1
  ...
  @question 'Bulge', 'How prominent is the central bulge, compared with the rest of the galaxy?', leadsTo: 'Do you see any of these odd features in the image?'->
    ...
    @answer 'Just noticeable', icon: 'bulge_noticeable', examples: 1
