...
SloanTree = new DecisionTree 'sloan', ->
  ...
  @question 'Is there a sign of a bar feature through the center of the galaxy?', leadsTo: 'Is there any sign of a spiral arm pattern?', ->
    @answer 'Bar'
    @answer 'No bar'
  ...
  @question 'How prominent is the central bulge, compared with the rest of the galaxy?', leadsTo: 'Is there anything odd?', ->
    @answer 'No bulge'
  ...
  @question 'What are the odd features?', ->
    @answer 'Ring'
    @answer 'Lens or arc'
    @answer 'Disturbed'
    @answer 'Irregular'
  ...
  @question 'How rounded is it?', leadsTo: 'Is there anything odd?', ->
    @answer 'Completely round'
    @answer 'In between'
    @answer 'Cigar shaped'
  
  @question 'Does the galaxy have a bulge at its center? If so, what shape?', leadsTo: 'Is there anything odd?', ->
    @answer 'Rounded'
    @answer 'Boxy'
    @answer 'No bulge'
